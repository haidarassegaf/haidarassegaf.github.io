                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="loker_buku" class="col-sm-3 control-label">Loker Buku</label>
                               <div class="col-sm-2 col-xs-9">
                                <select name="loker_buku" class="form-control">
                                    ...
                                    <option value="Buku Informaasi">Buku Informasi</option>
                                    <option value="Buku Pembelajaran">Buku Pembelajaran</option>
                                    <option value="Buku Kamus">Buku Kamus</option>
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="kode_buku" class="form-control" id="inputEmail3" placeholder="Inputkan Kode" required>
                            </div>
                        </div>
						 <div class="form-group">
                            <label for="jumlah_buku" class="col-sm-3 control-label">Jumlah Buku</label>
                            <div class="col-sm-9">
                                <input type="text" name="jumlah_buku" class="form-control" id="inputEmail3" placeholder="Inputkan Jumlah Buku" required>
                            </div>
                        </div>
						 <div class="form-group">
...
if($_POST){
  ...
  $status=$_POST['status'];
	$ket=$_POST['ket'];
    //buat sql
    $sql="INSERT INTO buku VALUES ('','$loker_buku','$buku','$jumlah','$judulbuku','$pengarang','$tahun_terbit','$penerima','$penerbit','$status','$ket')";
