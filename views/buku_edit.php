                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="kode_buku" value="<?=$data['kode_buku']?>"class="form-control" id="inputEmail3" placeholder="kode_buku">
                            </div>
                        </div>
						<div class="form-group">
                            <label for="jumlah_buku" class="col-sm-3 control-label">Jumlah Buku</label>
                            <div class="col-sm-9">
                                <input type="text" name="jumlah_buku" value="<?=$data['jumlah_buku']?>"class="form-control" id="inputEmail3" placeholder="Jumlah_buku">
                            </div>
                        </div>
						<div class="form-group">
...
if($_POST){
	...
	$ket=$_POST['ket'];
    //buat sql
    $sql="UPDATE buku SET loker_buku='$lokerbuku',kode_buku='$buku',jumlah_buku='$jumlah',judul_buku='$judulbuku',
